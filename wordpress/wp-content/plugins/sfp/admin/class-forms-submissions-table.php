<?php
/**
 * Administration API: License_Manager_List_Table class
 *
 * @package WordPress
 * @subpackage License_Manager_List
 * @since 3.1.0
 */
 ...
 * @access private
 */
class Forms_Submissions_Table_List {
...
<p class="search-box">
	...
	<input type="search" id="<?php echo esc_attr( $input_id ); ?>" name="s" value="<?php _admin_search_query(); ?>" />
		<?php submit_button( $text, '', '', false, array( 'id' => 'search-submit-revenues' ) ); ?>
</p>
		<?php
	}
	...
	protected function bulk_actions( $which = '' ) {
		...
		echo '<select name="action' . $two . '" id="revenues-bulk-action-selector-' . esc_attr( $which ) . "\">\n";
		...
		submit_button( __( 'Apply' ), 'action', '', false, array( 'id' => "doaction$two", 'data-action-type'=>"revenue" ) );
		echo "\n";
	}
...
<table class="wp-list-table <?php echo implode( ' ', $this->get_table_classes() ); ?>">
	...
	<div class="tablenav <?php echo esc_attr( $which ); ?>">
		...
		<div class="alignleft revenues actions bulkactions">
